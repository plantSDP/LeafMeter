...
class ScanViewController: UITableViewController, CBCentralManagerDelegate {
    var peripherals:[CBPeripheral] = []
    var manager:CBCentralManager? = nil
    var parentView:RootController? = nil
    let HM10service = CBUUID(string: "FFE0")
    ...
    func scanBLEDevices() {
        ...
        manager?.scanForPeripherals(withServices: [HM10service], options: nil) //searches only for HM-10
